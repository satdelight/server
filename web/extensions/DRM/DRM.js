...
var drm = {
   ...
   database_url: [
      kiwi_SSL() +'downloads.rx-888.com/webconfig/drmrx.cjson',
      kiwi_SSL() +'downloads.rx-888.com/webconfig/stations2.cjson'
   ],
...
function drm_schedule_time_freq(sort_by_freq)
{
   ...
   var i, j;
   var s = drm.using_default? w3_div('w3-yellow w3-padding w3-show-inline-block', 'can\'t contact rx-888.com<br>using default data') : '';
   var narrow = drm.narrow_listing;
   drm.stations_freq = [];
      ...
      var s = 
         ...
         w3_div('w3-margin-T-8 w3-scroll-y|height:90%',
            w3_div('w3-margin-R-8',
               ...
               'waterfall colors are not saturated. The image below shows fading (dark areas) that might cause problems.' +
